        ...
        <div class="overlap-wrapper">
            <div class="overlap">
                ...
                <div class="button-group">
                    <button class="button" wire:click="$emit('openLoginModal')"
                            onclick="console.log('Login Button clicked')">Login
                    </button>

                    <button class="button-wrapper" wire:click="$emit('openRegisterModal')"
                            onclick="console.log('Register button clicked')">Register
                    </button>
                </div>
